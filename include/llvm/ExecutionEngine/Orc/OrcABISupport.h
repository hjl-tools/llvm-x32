...
template <unsigned StubSizeVal, unsigned SlotSizeVal = sizeof(void *)>
class GenericIndirectStubsInfo {
public:
  const static unsigned StubSize = StubSizeVal;
  const static unsigned SlotSize = SlotSizeVal;
  ...
  void **getPtr(unsigned Idx) const {
    ...
    char *Slot = PtrsBase + SlotSize * Idx;
...
public:
  ...
  // X32 has 32-bit pointer with indirect branch via 64-bit slot.
  typedef GenericIndirectStubsInfo<8,8> IndirectStubsInfo;
