...
; RUN: llc < %s -mtriple=x86_64-unknown -mpointersize=64                            | FileCheck %s --check-prefix=CHECK-64
; RUN: llc < %s -mtriple=x86_64-unknown -mpointersize=64 -fast-isel -fast-isel-abort=1 | FileCheck %s --check-prefix=CHECK-64
