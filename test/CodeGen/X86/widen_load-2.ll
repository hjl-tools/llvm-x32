...
; RUN: llc < %s -mtriple=x86_64-gnux32 -mattr=+sse4.2 | FileCheck %s
...
; CHECK-LABEL: add3i32:
; CHECK:       # BB#0:
; CHECK-NEXT:    movdqa (%{{r|e}}si), %xmm0
; CHECK-NEXT:    paddd (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    pextrd $2, %xmm0, 8(%{{r|e}}di)
; CHECK-NEXT:    movq %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    pinsrd $2, 8(%{{r|e}}si), %xmm0
; CHECK-NEXT:    movq {{.*#+}} xmm1 = mem[0],zero
; CHECK-NEXT:    pinsrd $2, 8(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    paddd %xmm0, %xmm1
; CHECK-NEXT:    pextrd $2, %xmm1, 8(%{{r|e}}di)
; CHECK-NEXT:    movq %xmm1, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK:       # BB#0:
; CHECK-NEXT:    movdqa (%{{r|e}}si), %xmm0
; CHECK-NEXT:    movdqa 16(%{{r|e}}si), %xmm1
; CHECK-NEXT:    paddd (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    paddd 16(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    pextrd $2, %xmm1, 24(%{{r|e}}di)
; CHECK-NEXT:    movq %xmm1, 16(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    movdqa (%{{r|e}}si), %xmm0
; CHECK-NEXT:    movdqa 16(%{{r|e}}si), %xmm1
; CHECK-NEXT:    movdqa 32(%{{r|e}}si), %xmm2
; CHECK-NEXT:    paddd (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    paddd 16(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    paddd 32(%{{r|e}}dx), %xmm2
; CHECK-NEXT:    movdqa %xmm2, 32(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm1, 16(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    movdqa (%{{r|e}}si), %xmm0
; CHECK-NEXT:    movdqa 16(%{{r|e}}si), %xmm1
; CHECK-NEXT:    paddw (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    paddw 16(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    movq %xmm1, 16(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    paddw (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    paddw 16(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    paddw 32(%{{r|e}}dx), %xmm2
; CHECK-NEXT:    movd %xmm2, 32(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm1, 16(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    paddd %xmm0, %xmm1
; CHECK-NEXT:    pextrb $8, %xmm1, 2(%{{r|e}}di)
...
; CHECK-NEXT:    pextrw $0, %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
; CHECK-NEXT:    retq
...
; CHECK-NEXT:    movdqa (%{{r|e}}si), %xmm0
; CHECK-NEXT:    movdqa 16(%{{r|e}}si), %xmm1
; CHECK-NEXT:    paddb (%{{r|e}}dx), %xmm0
; CHECK-NEXT:    paddb 16(%{{r|e}}dx), %xmm1
; CHECK-NEXT:    pextrb $14, %xmm1, 30(%{{r|e}}di)
; CHECK-NEXT:    pextrw $6, %xmm1, 28(%{{r|e}}di)
; CHECK-NEXT:    pextrd $2, %xmm1, 24(%{{r|e}}di)
; CHECK-NEXT:    movq %xmm1, 16(%{{r|e}}di)
; CHECK-NEXT:    movdqa %xmm0, (%{{r|e}}di)
; CHECK-NEXT:    mov{{q|l}} %{{r|e}}di, %{{r|e}}ax
...
; CHECK-NEXT:    pextrw $0, %xmm1, (%{{r|e}}si)
; CHECK-NEXT:    movb $-98, 2(%{{r|e}}si)
; CHECK-NEXT:    movdqa {{.*#+}} xmm1 = <1,1,1,u>
; CHECK-NEXT:    pshufb %xmm0, %xmm1
; CHECK-NEXT:    pmovzxwq {{.*#+}} xmm0 = xmm1[0],zero,zero,zero,xmm1[1],zero,zero,zero
; CHECK-NEXT:    pextrw $0, %xmm0, (%{{r|e}}dx)
; CHECK-NEXT:    movb $1, 2(%{{r|e}}dx)
; CHECK-NEXT:    pmovzxbd {{.*#+}} xmm0 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero
